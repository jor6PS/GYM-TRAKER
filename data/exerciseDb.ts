...
const entries: ExerciseDef[] = [
  ...
  { id: 'incline_bench_barbell', en: "Incline Bench Press", es: "Press Inclinado (Barra)" },
  { id: 'incline_bench_dumbbell', en: "Incline Bench (Dumbbell)", es: "Press Inclinado (Mancuernas)" },
  ...
  { id: 'chest_press_machine', en: "Chest Press Machine", es: "Press de Pecho (Máquina)" },
  ...
  { id: 'lunges_dumbbell', en: "Lunges", es: "Zancadas" },
  ...
  { id: 'leg_curl_seated', en: "Leg Curl", es: "Curl Femoral (Sentado/Tumbado)" },
  { id: 'leg_extension', en: "Leg Extension", es: "Extensiones de Cuádriceps" },
  { id: 'calf_raise_standing', en: "Calf Raise", es: "Elevación de Gemelos" },
  { id: 'hip_thrust', en: "Hip Thrust", es: "Hip Thrust / Puente de Glúteo" },
  { id: 'hack_squat', en: "Hack Squat", es: "Sentadilla Hack" },

  // --- SHOULDERS ---
  { id: 'overhead_press_barbell', en: "Overhead Press", es: "Press Militar (Barra)" },
  { id: 'shoulder_press_dumbbell', en: "Shoulder Press (Dumbbell)", es: "Press de Hombros (Mancuernas)" },
  { id: 'lateral_raise_dumbbell', en: "Lateral Raise", es: "Elevaciones Laterales" },
  { id: 'front_raise', en: "Front Raise", es: "Elevaciones Frontales" },
  { id: 'rear_delt_fly_dumbbell', en: "Rear Delt Fly", es: "Pájaros / Deltoides Posterior" },
  ...
  // --- ARMS ---
  { id: 'bicep_curl_barbell', en: "Bicep Curl", es: "Curl de Bíceps (Barra)" },
  ...
  { id: 'tricep_pushdown_rope', en: "Tricep Pushdown", es: "Extensión de Tríceps (Polea)" },
